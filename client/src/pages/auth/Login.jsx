  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden -z-10 bg-gray-50 dark:bg-gray-900">
        <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] rounded-full bg-primary-400/20 blur-3xl" />
        <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] rounded-full bg-accent-400/20 blur-3xl" />
      </div>
        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-sm">
              <Link to="/forgotpassword" className="font-medium text-primary-600 hover:text-primary-500 transition-colors">
                Forgot password?
              </Link>
            </div>
          </div>
