        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-8">
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex space-x-3 text-gray-400">
              <a href="#" className="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-primary-600 transition-colors"><FiTwitter size={18} /></a>
              ...
              <a href="#" className="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-primary-600 transition-colors"><FiGithub size={18} /></a>
            </div>
          </div>
          ...
          <div>
            <h3 className="font-bold text-gray-900 dark:text-white text-sm mb-4 uppercase tracking-wider">Resources</h3>
            <ul className="space-y-2.5">
              <li><Link to="/courses" className="text-sm text-gray-500 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">Help Center</Link></li>
              <li><Link to="/courses" className="text-sm text-gray-500 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">Certificate Verification</Link></li>
              <li><Link to="/courses" className="text-sm text-gray-500 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">FAQ</Link></li>
            </ul>
          </div>

          <div>
            <h3 className="font-bold text-gray-900 dark:text-white text-sm mb-4 uppercase tracking-wider">Legal</h3>
            <ul className="space-y-2.5">
              <li><Link to="/courses" className="text-sm text-gray-500 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">Terms of Service</Link></li>
              <li><Link to="/courses" className="text-sm text-gray-500 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">Privacy Policy</Link></li>
              <li><Link to="/courses" className="text-sm text-gray-500 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">Refund Policy</Link></li>
            </ul>
          </div>
        </div>
