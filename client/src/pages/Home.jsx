...
import { FiArrowRight, FiCheckCircle, FiUsers, FiAward, FiVideo, FiBookOpen } from 'react-icons/fi';
            ...
            >
              <div className="relative w-full aspect-square max-w-lg mx-auto">
                ...
                <img
                  ...
                  className="rounded-3xl shadow-2xl object-cover w-full h-full border-4 border-white dark:border-gray-800 relative z-10"
                />
                ...
                <motion.div
                  ...
                  className="absolute -right-6 bottom-24 bg-white dark:bg-gray-900 p-4 rounded-xl shadow-xl border border-gray-100 dark:border-gray-800 z-20 flex items-center space-x-3"
                >
